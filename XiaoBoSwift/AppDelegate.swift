    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let barFont = UIFont(name: "Avenir-Light", size: 24) {
            UINavigationBar.appearance().titleTextAttributes = [
                ...
                NSForegroundColorAttributeName : #colorLiteral(red: 0.5058823824, green: 0.3372549117, blue: 0.06666667014, alpha: 1)
            ]
        
//            无导航栏生效 全局状态栏样式
            UIApplication.shared.statusBarStyle = .lightContent
        }
        AVOSCloud.setApplicationId("qDy1GQciNpWFwHFpVsBbP1et-gzGzoHsz", clientKey: "rA0NH6bi58IDzIFrbG7NrukD")
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "XiaoBoSwift")
